...
//    SQLiteDatabase
    public void operate(View v){
        ...
        } else if (vId == R.id.select_btn) {//select 列名 from 表名 where 列1 = 值1 and 列2 = 值2
